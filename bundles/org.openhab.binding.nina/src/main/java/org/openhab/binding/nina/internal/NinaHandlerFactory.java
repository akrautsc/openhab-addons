...
/**
 * The {@link NinaHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
 * @author Andre Krautschick - Initial contribution
 */
@NonNullByDefault
@Component(configurationPid = "binding.nina", service = ThingHandlerFactory.class)
public class NinaHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_NINA.equals(thingTypeUID)) {
            return new NinaHandler(thing, httpClient);
        }
